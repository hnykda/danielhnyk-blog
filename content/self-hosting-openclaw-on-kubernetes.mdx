export const metadata = {
  ...
  description:
    "How I run OpenClaw on a single-node Kubernetes cluster: a custom Docker image with extra tools, Mattermost as the chat surface, and full control over the data.",
  date: "2026-02-27",
  tags: ["IT", "devops", "AI"],
};

...
*Part 1 of a series on using Claude Code as a production runtime. Originally published on [everyrow.io](https://everyrow.io/blog/claude-code-kubernetes-cronjob).*

---

We run Claude Code in Kubernetes for a set of long-running marketing CronJobs. One scans communities like subreddits and support forums, another searches for news and generates relevant content, and the last one optimizes SEO for [everyrow.io](https://everyrow.io), our data processing product.
...
*We build [everyrow.io](https://everyrow.io) - tools for semantic deduplication, entity resolution, and qualitative ranking of datasets. This pipeline is how we find people who need them.*

---

*Next: [Using Claude Code as a Workflow Engine](/claude-code-workflow-engine/)*

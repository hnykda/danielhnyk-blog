export const metadata = {
  ...
  description:
    "What it takes to run Claude Code as a production Kubernetes CronJob: the Dockerfile, entrypoint, auth, project structure, and the gotchas we hit along the way.",
  date: "2026-02-26",

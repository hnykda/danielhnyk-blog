export const metadata = {
  ...
  description:
    "Testing in-review PRs on a live deployment without maintaining a fork: keep .patch files in your repo and git-apply them to the upstream image during docker build.",
  date: "2026-02-27",
  tags: ["IT", "devops"],
};

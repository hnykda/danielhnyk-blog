export const metadata = {
  ...
  description:
    "How we scan 18 community sources every weekday with Claude Code: fetch posts, enrich threads, classify with a 20-question rubric, draft responses, open a PR.",
  date: "2026-03-11",

export const metadata = {
  ...
  date: "2026-06-10",
  description:
    "Anthropic blocked Claude subscription use through OpenClaw, so I rebuilt my self-hosted multi-agent Mattermost setup on native Claude Code: Kubernetes, Helm chart, cron, persistent memory, agent-to-agent messaging. Open-sourced as talon.",
